...
HGDIOBJ __thiscall FUN_00405497(void *this,int param_1,HDC param_2,undefined4 param_3)

{
  ...
  if (param_1 == 0x133) {
    ...
    if ((param_1 == 0x20) && (iVar2 = GetDlgCtrlID((HWND)param_2), iVar2 == 0x3f2)) {
