...
int * __thiscall FUN_00404974(void *this,int *param_1,int param_2,int *param_3)
...
LAB_00404a14:
          ...
          *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0xc) = 0;
          ...
          if (piVar5 == (int *)piVar3[2]) {
            FUN_00404abe(this,(int)piVar3);
            piVar5 = piVar3;
          }
          *(undefined1 *)(piVar5[1] + 0xc) = 1;
          *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0xc) = 0;
          FUN_00404c7f(this,*(int **)(piVar5[1] + 4));
        }
      }
      else {
        if ((char)piVar4[3] == '\0') goto LAB_00404a14;
        if (piVar5 == (int *)*piVar3) {
          FUN_00404c7f(this,piVar3);
          piVar5 = piVar3;
        }
        *(undefined1 *)(piVar5[1] + 0xc) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0xc) = 0;
        FUN_00404abe(this,*(int *)(piVar5[1] + 4));
      }
